...
import { CounterProps, FormStateProps } from "@/types";
...
const INITIAL_FORM: FormStateProps = {
  title: "",
  description: "",
  price: "",
  type: "apartment",
...
export default function CreatePropertyScreen() {
  ...
  const [form, setForm] = useState<FormStateProps>(INITIAL_FORM);
  ...
  const updateForm = (fields: Partial<FormStateProps>) =>
